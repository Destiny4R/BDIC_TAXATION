...
{
    public class RepositoryLogActivity : Repository<LogActivity>, IRepositoryLogActivity
    {
        private readonly ApplicationDbContext context;

        public RepositoryLogActivity(ApplicationDbContext context) : base(context)
        {
