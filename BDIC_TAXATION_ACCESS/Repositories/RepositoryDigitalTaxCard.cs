...
{
    public class RepositoryDigitalTaxCard : Repository<DigitalTaxCard>, IRepositoryDigitalTaxCard
    {
        private readonly ApplicationDbContext context;

        public RepositoryDigitalTaxCard(ApplicationDbContext context) : base(context)
        {
